    ...
    async processSignup(req, res, next) {
        try {
            ...
            if (checkExistUsername) {
                ...
                if (!id) {
                    u = new user(1, username, password, fullname, email, null, null, null, process.env.ROLE_USER, true, process.env.money);

                }
                else {
                    u = new user(id + 1, username, password, fullname, email, null, null, null, process.env.ROLE_USER, true, process.env.money);
                }
